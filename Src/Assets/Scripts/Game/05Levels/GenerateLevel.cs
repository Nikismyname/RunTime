...
public class GenerateLevel
{
    ...
    {
        var prefab = ReferenceBuffer.Instance.EditorInput.cylinderPrefab;
        ...
        Type[] scriptTypes = null)
    {
        ...
        if (enType == EntityType.Target)
        {
            ...
            this.ms.registry.RegisterTarget(entity, TargetType.Standard);
        }
    ...
    public Script AddEditableScriptToEntity<Script>(GameObject entity, string source) where Script: MonoBehaviour
    {
        ...
        ms.attacher.AttachCompiletimeMono(entity, funcs, script, source);
        return script;
    }
        ...
        )
    {
        ...
        ms.registry.RegisterTarget(testEntity, tType, testName);
        ...
        if (enType == EntityType.Target)
        {
            ...
            if (scriptsToRegister != null)
            {
                foreach (var scriptType in scriptsToRegister)
                {
                    ...
                    this.ms.attacher.AttachCompiletimeMono(entity, funcs, script, "");
                }
            }
        }
        ...
        Type[] scriptsToRegister = null)
    {
        ...
        if (enType == EntityType.Target)
        {
            ...
            this.ms.registry.RegisterTarget(scriptsObject, TargetType.Standard);
            ...
            if (scriptsToRegister != null)
            {
                foreach (var scriptType in scriptsToRegister)
                {
                    ...
                    var funcs = Compilation.GenerateAllMethodsFromMonoType(scriptType);
                    this.ms.attacher.AttachCompiletimeMono(scriptsObject, funcs, script, "");
                }
            }
        }
