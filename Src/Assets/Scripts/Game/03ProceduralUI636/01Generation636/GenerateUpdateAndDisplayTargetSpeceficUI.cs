...
/// It recives information from the Main <see cref="TargetManagerBehaviour"> about the 
...
/// the entered inputs.
/// </summary>]
public class GenerateUpdateAndDisplayTargetSpeceficUI : MonoBehaviour
{
    ...
    #region SET_TARGET
    /// <summary>
    /// This mothod is called from main <see cref="TargetManagerBehaviour"> to indicate that new target 
    ...
    {
        var button = Instantiate(ReferenceBuffer.Instance.EditorInput.buttonPreFab, parent);
    ...
    {
        var input = Instantiate( ReferenceBuffer.Instance.EditorInput.inputPrefab, parent);
