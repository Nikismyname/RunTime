...
public class TargetManagerBehaviour : MonoBehaviour
{
    ...
    void Awake()
    {
        this.manageButtons = GameObject.Find("ActionsContent").GetComponent<GenerateUpdateAndDisplayTargetSpeceficUI>();
        ...
        ///Every two seconds check for destroyed monos and send message to <see cref="GenerateUpdateAndDisplayTargetSpeceficUI"> 
